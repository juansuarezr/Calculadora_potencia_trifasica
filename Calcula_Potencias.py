...
ax_voltaje = fig.add_axes([0.1,0.72,0.21,0.12], ylabel = "$Tensión(V)$", xlabel = "$Tiempo (s)$")
...
texto = fig.text(0.6,0.08,"Potencia activa (P): " + str(round(valores[0],3)) + " kW\nPotencia reactiva (Q): " + str(round(valores[1],3)) + " kVAR\nPotencia aparente aritmética (Sa): " + str(round(valores[2],3)) + " kVA\nPotencia aparente vectorial (Sv): " + str(round(valores[3],3)) + " kVA\nPotencia aparente efectiva (Se): " + str(round(valores[4],3))
                 ...
                 + "\nFactor de potencia efectiva: " + str(round(tf.calcula_potencias(v1,v2,v3,i1,i2,i3)[7],3)) + 
                 "\nPotencia de desequilibrio: " + str(round(tf.calcula_potencias(v1,v2,v3,i1,i2,i3)[8]/1000,3)) + " kVA")
texto_corriente = fig.text(0.1,0.88,"Sistema trifásico (tensiones de fase)", fontsize = 15)
